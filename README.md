...
FACTOR = {"kg": 0, "g": 3}
unit_cost_normalized = unit_cost
...
``
***
...
При небольшом количестве единиц измерения можно держать константой в коде, при увеличении количества единиц измерения
целесообразно хранить в БД
